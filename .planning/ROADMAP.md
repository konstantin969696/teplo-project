...
| 04.2 | Root-cause `systemOrder undefined` | 🔴 not-started | 04.1 | Понять, почему systemOrder приходил undefined (Zustand-persist race? старый persisted state?). Закрыть техдолг по миграции. |
