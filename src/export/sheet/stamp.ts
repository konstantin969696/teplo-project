...
export const STAMP_GEOMETRY = {
  ...
  title: {
    ...
    width: 70,
    height: 45,
    // Внутри: верх 15 — графа 2 (обозначение шифр), низ — графа 1 (название)
    designationHeight: 15
  },

  // Графы 4/7/8 — Стадия / Лист / Листов (мини-таблица под title)
  // 70мм × 10мм, 2 строки: верх — заголовки (Стадия/Лист/Листов), низ — значения
  stage: {
    x: 75,
    y: 45,
    width: 70,
    height: 10,
    cols: [
      { id: 'stage', label: 'Стадия', width: 30 },
